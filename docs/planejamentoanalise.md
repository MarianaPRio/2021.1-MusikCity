...
:-------:|-----------|:---------
1	|<p style="text-align: justify">Qual o seu nome completo?</p>|- Discursiva.
...
5.1	|<p style="text-align: justify">O quão difícil foi para você encontrar essa funcionalidade? (Caso seja um profissional da música).</p>| - Discursiva.
5.2	|<p style="text-align: justify">Como você faria para encontrar o formulário para demonstrar interesse em uma possível divulgação? (Caso seja um profissional da música).</p>| - Demonstrar.
5.3	|<p style="text-align: justify">Estando na página inicial, como você faria para encontrar a funcionalidade de escutar rádios ao-vivo no site MusicCity?(Caso tenha o perfil de amante da música). </p>| - Demonstrar.
5.4	|<p style="text-align: justify">O quão difícil foi para você encontrar essa funcionalidade? (Caso tenha o perfil de amante da música).| - Discursiva.
5.5	|<p style="text-align: justify">Estando na página inicial, como você faria para encontrar a funcionalidade de escutar parada top 50? (Caso tenha o perfil de amante da música).</p>| - Demonstrar.
5.6	|<p style="text-align: justify">O quão difícil foi para você encontrar essa funcionalidade? (Caso tenha o perfil de amante da música).</p>| - Discursiva.

<p style="text-indent: 20px; text-align: justify">
Perguntas sobre a funcionalidade de marcar divulgação artística (Perfil profissional da música).
</p>

Número  | Pergunta  | <div style="width:100px">resposta</div>
:-------:|-----------|:---------
6	|<p style="text-align: justify">Sobre as perguntas presentes no formulário, caso você desejasse marcar uma divulgação artística você se sentiria confortável em responde-las?</p>| - Sim.<br>- Não.
7	|<p style="text-align: justify">A maneira como o preenchimento do formulário é apresentada é confortável para você? (Tamanho e formato da caixa de resposta).</p>| - Sim.<br>- Não.
8	|<p style="text-align: justify">Você considera que iria encontrar dificuldades para o preenchimento do formulário? Se sim aponte possíveis problemas que iria encontrar.</p>| - Discursiva

<p style="text-indent: 20px; text-align: justify">
Perguntas sobre a funcionalidade de escutar uma rádio ao-vivo no site (Perfil para amantes da música).
</p>
